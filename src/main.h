...
#define START_MASTERNODE_PAYMENTS_TESTNET 1526486699
#define START_MASTERNODE_PAYMENTS 1526486699

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 AKL per COIN i.e. 8%
static const int64_t TARGET_SPACING = 30;
...
static const int64_t MAX_MONEY = 72000000 * COIN; // 1M PoW coins
