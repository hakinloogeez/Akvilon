...
/**
 * Split AkvilonCoin command line into a list of arguments. Aims to emulate \c AKL and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AkvilonCoin RPC console.") + "<br>" +
